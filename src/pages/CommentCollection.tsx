...
export default function CommentCollection() {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_: any, record: any) => {
        // console.log('渲染收集评论数量:', { 
        //   task_id: record.task_id, 
        //   crawler_progress: record.crawler_progress,
        //   record: record 
        // });
        return (
    ...
    },
    {
      ...
      render: (_: any, record: any) => {
        // console.log('渲染分析评论数量:', { 
        //   task_id: record.analysis_progress,
        //   record: record 
        // });
        return (
